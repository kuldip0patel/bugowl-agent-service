...
class Agent(Generic[Context]):
	...
	def __init__(
		...
		# Create a valid Python identifier from session_id by replacing hyphens with underscores
		eventbus_name = f'Agent_{self.session_id.replace("-", "_")}'
		self.eventbus = EventBus(name=eventbus_name, wal_path=wal_path)
