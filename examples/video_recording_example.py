...
from browser_use.browser.utils.video_recorder import LiveStreamer, VideoRecorder, capture_screen
...
async def main():
	...
	video_recorder = VideoRecorder(save_dir='videos/', width=1920, height=1080, fps=30)

	# Initialize streaming (optional)
	streamer = LiveStreamer(stream_url='rtmp://your-streaming-server/live/stream', width=1920, height=1080, fps=30)
	...
	browser = Browser(config=BrowserConfig(headless=False, new_context_config=context_config))
